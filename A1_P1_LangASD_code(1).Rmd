...
Data1 = select(demo_train, SUBJ, VISIT, Ethnicity, Diagnosis, Gender, Age, ADOS, MullenRaw,ExpressiveLangRaw)
Data1 = rename(Data1, c("MullenRaw"="nonverbalIQ", "ExpressiveLangRaw"="verbalIQ"))
Data2 = select(LU_train,SUBJ, VISIT, MOT_MLU, MOT_LUstd, CHI_MLU, CHI_LUstd)
Data3 = select(token_train,SUBJ, VISIT, types_MOT, types_CHI, tokens_MOT, tokens_CHI)
...
all_data$SUBJ = as.factor(all_data$SUBJ)
all_data$SUBJ = as.numeric(all_data$SUBJ, levels =61)
