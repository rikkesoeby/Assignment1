...
#average
summary(model3)
#making a fake child based on the TD children by averaging them
...
pred1 =predict(model3,fakeChild,allow.new.levels=TRUE)
#Bernies prediction
pred2 = predict(model3,bernie,allow.new.levels=TRUE)
pred2 -pred1

b6 =subset(bernie, VISIT ==6)
pred1 = predict(model3,b6)
pred1
b6$CHI_MLU -pred1
