...
contrasts(data$VISIT) = contr.poly(6) # 3 is the number of condi<ons
# run the ANOVA
ModelTrend = 
  
aov(CHI_MLU ~ 1 + VISIT + Diagnosis + (1+VISIT|SUBJ),REML = FALSE, data)
summary.lm(ModelTrend)

CHI_MLU ~ 1 + VISIT + Diagnosis + (1+VISIT|SUBJ),REML = FALSE, data
